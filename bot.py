...
def signin():
    ...
    time.sleep(0.75)
    driver.find_element_by_xpath('//*[@id="username"]').send_keys("# put your usename herejacob66")
    time.sleep(0.75)
    driver.find_element_by_xpath('//*[@id="password"]').send_keys("# put your password here05Drow8039")
    time.sleep(0.75)
