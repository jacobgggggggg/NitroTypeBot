...
def signin():
    ...
    time.sleep(0.75)
    driver.find_element_by_xpath('//*[@id="username"]').send_keys("# put your usename herejacob_6")
    time.sleep(0.75)
    driver.find_element_by_xpath('//*[@id="password"]').send_keys("# put your password here04Drow11")
    time.sleep(0.75)
